...
def get_train_transforms(dataset, transformer_model=False):
...
def get_inference_transforms(dataset, transformer_model=False, strong_inference=False):
    if dataset in ("market1501", "dukemtmc"):
        if strong_inference:
            if transformer_model:
...
def get_inference_transforms_flipped(dataset, transformer_model=False, strong_inference=False):
    if dataset in ("market1501", "dukemtmc"):
        if strong_inference:
            if transformer_model:
                transform_test = transforms.Compose([transforms.Resize((448, 224)),
